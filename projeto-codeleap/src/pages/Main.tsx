      ...
      <div className="bg-white border border-gray-300 w-[800px]">
        ...
        <div className="p-6 flex flex-col gap-6">
          <div className="w-[752px] h-[334px] border border-gray-300 rounded-2xl p-6">
            ...
            <button
              type="submit"
              className={`btn-create w-[111px] h-[32px] rounded-lg float-right text-white flex items-center justify-center ${
            ...
            <div className="bg-[#7695EC] h-[70px] flex items-center justify-between px-4">
              ...
              <div className="flex gap-4">
                <img
                  ...
                  alt="delete"
                  className="py-3.5 px-6.5  cursor-pointer"
                  onClick={() => setDeleteOpen(true)}
                />
                <img
                  src="/src/assets/icons/edit.svg"
                  alt="edit"
                  className="w-3.1 h-8.3 pl-9.1 pr-3.8 cursor-pointer"
